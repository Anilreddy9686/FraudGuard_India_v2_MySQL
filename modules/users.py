...
def all_users():
    ...
    try:
        ...
        return render_template("users_all.html", users=demo_users, stats=demo_stats, states=INDIAN_STATES, demo_mode=True)
...
def profile():
    ...
    try:
        ...
        stats={"total":10,"frauds":2,"volume":50000}
        recent_audit=[]
